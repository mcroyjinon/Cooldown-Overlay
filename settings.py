...
from buttons import Changeable_Buttons
...
class Display(CTk.CTkFrame):
    ...
    def display_buttons(self,index):
        ...
        keybind_button=Changeable_Buttons(self,keybinds[index],'keybind')
        keybind_button.pack(expand=True, side='left',fill='x',padx=2.5)

        name_button=Changeable_Buttons(self,keybinds[index],'name')
        name_button.pack(expand=True, side='left',fill='x',padx=2.5)

        cooldown_button=Changeable_Buttons(self,keybinds[index],'cooldown')
