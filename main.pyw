...
class Main_App(CTk.CTk):
    ...
    def __init__(self):
        ...
        settings_button: CTk.CTkButton = CTk.CTkButton(
            settings_frame,
            height=15,
            width=15,
            text="Settings",
        ...
        update_button: CTk.CTkButton = CTk.CTkButton(
            settings_frame,
            height=15,
            width=15,
    ...
    def enter_settings(self) -> None:
        hwnd: int | None = win32gui.FindWindow(
    ...
    def change_key(self, key: keyboard.Key) -> None:
    ...
    def update_keybinds(self):
        #  Find Saves File
        self.saves: ConfigParser = ConfigParser()
